...
$msg =sprintf(__('Want to save contact form 7 submissions? Manage contact form 7 entries , view Zoho status of any entry and Resend any entry to Zoho CRM with free %sContact Form Entries Plugin%s','crm-perks-forms'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">','</a>');
?>
